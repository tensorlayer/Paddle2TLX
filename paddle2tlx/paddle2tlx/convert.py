...
def get_params():
    ...
    parser.add_argument(
        ...
        "-idp",
        type=_text_type,
        default="D:/ProjectByPython/code/myproject/model-convert-tools/convert_test/pd_models",
        help="define project folder path for paddle")
    parser.add_argument(
        "--output_dir_tlx",
        "-odt",
        type=_text_type,
        default="D:/ProjectByPython/code/myproject/model-convert-tools/convert_test/tlx_models",
    ...
    parser.add_argument(
        ...
        "-pm",
        type=_text_type,
        default="D:/Model/tlx_pretrained_model",

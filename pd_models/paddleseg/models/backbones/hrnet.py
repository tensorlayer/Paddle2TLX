...
from paddle.nn.initializer import Uniform  # todo - add
import paddle.nn.functional as F
from models import manager, layers
...
class HRNet(nn.Layer):
    ...
    #         utils.load_pretrained_model(self, self.pretrained)  # TODO - model parameters init here

...
class WindowAttention(nn.Layer):
    ...
    def __init__(self,
        ...
        b_init = None
        b_init = self.init_pd(b_init, qkv_bias)  # todo
        self.qkv = nn.Linear(dim, dim * 3, bias_attr=b_init)
    ...
    def __init__(self,
        ...
        if downsample is not None:
            self.downsample = downsample(
                input_resolution, dim=dim, layer_norm=layer_norm)
        else:
...
class SwinTransformer(nn.Layer):
    ...
    def __init__(self,
        ...
        self.patch_embed = PatchEmbed(
            ...
            in_chans=in_chans,
            embed_dim=embed_dim,
            layer_norm=layer_norm if self.patch_norm else None)
    ...
    def _init_weights(self, m):
        ...
        if isinstance(m, nn.Linear):
            if tensorlayerx.BACKEND == 'tensorflow':
                ...
                # if isinstance(m, nn.Linear) and m.b_init is not None:
                #     zeros_(m.biases)
        elif isinstance(m, nn.LayerNorm):
            if tensorlayerx.BACKEND == 'tensorflow':
                zeros_(m.bias)
...
def swintransformer_tiny_patch4_window7_224(pretrained=False, **kwargs):
    return _swin_transformer("swintransformer_tiny_patch4_window7_224", pretrained=pretrained, **kwargs)


def swintransformer_small_patch4_window7_224(pretrained=False, **kwargs):
    return _swin_transformer("swintransformer_small_patch4_window7_224", pretrained=pretrained, **kwargs)


def swintransformer_base_patch4_window7_224(pretrained=False, **kwargs):
    return _swin_transformer("swintransformer_base_patch4_window7_224", pretrained=pretrained, **kwargs)
    

def swintransformer_base_patch4_window12_384(pretrained=False, **kwargs):
    return _swin_transformer("swintransformer_base_patch4_window12_384", pretrained=pretrained, **kwargs)
    

def swintransformer_large_patch4_window7_224(pretrained=False, **kwargs):
    return _swin_transformer("swintransformer_large_patch4_window7_224", pretrained=pretrained, **kwargs)
    

def swintransformer_large_patch4_window12_384(pretrained=False, **kwargs):
    return _swin_transformer("swintransformer_large_patch4_window12_384", pretrained=pretrained, **kwargs)

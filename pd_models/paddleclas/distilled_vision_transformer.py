...
from vision_transformer import VisionTransformer, trunc_normal_, zeros_
...
class DistilledVisionTransformer(VisionTransformer):
    ...
    def forward_features(self, x):
        ...
        x = x + self.pos_embed
        x = self.pos_drop(x)
        # print(x.sum(),'0000000000000000000000')
...
def DeiT_small_distilled_patch16_224(arch, pretrained=False,
                                     use_ssld=False,
                                     **kwargs):
...
def Distilled_vision_transformer_small(pretrained=False, **kwargs):
    model = DeiT_small_distilled_patch16_224("DeiT_small_distilled_patch16_224", pretrained=pretrained, **kwargs)
    return model


def Distilled_vision_transformer_base(pretrained=False, **kwargs):
    model = DeiT_base_distilled_patch16_224("DeiT_base_distilled_patch16_224", pretrained=pretrained, **kwargs)
    return model

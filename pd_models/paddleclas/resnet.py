...
class BasicBlock(nn.Layer):
    ...
    def __init__(self,
        ...
        self.conv1 = nn.Conv2D(inplanes,
                               ...
                               stride=stride,
                               bias_attr=False)
        self.bn1 = batch_norm(num_features=planes)
        self.relu = nn.ReLU()
        self.conv2 = nn.Conv2D(planes, planes, 3, padding=1, bias_attr=False)
        self.bn2 = batch_norm(num_features=planes)
...
class BottleneckBlock(nn.Layer):
    ...
    def __init__(self,
        ...
        self.bn1 = batch_norm(num_features=width)
        ...
        self.conv2 = nn.Conv2D(width,
                               ...
                               dilation=dilation,
                               bias_attr=False)
        self.bn2 = batch_norm(num_features=width)
...
class ResNet(nn.Layer):
    ...
    def __init__(self,
        ...
        # self._batch_norm = nn.BatchNorm2D  # 需人工修改
        ...
        self.conv1 = nn.Conv2D(3,
                               ...
                               padding=3,
                               bias_attr=False)
        # self.bn1 = self._batch_norm(num_features=self.inplanes)
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                nn.Conv2D(self.inplanes,
                          ...
                          stride=stride,
                          bias_attr=False),
                batch_norm(num_features=planes * block.expansion),
            )

        layers = []
        layers.append(
            block(self.inplanes, planes, stride, downsample, self.groups,
                  self.base_width, previous_dilation, batch_norm))

...
from vision_transformer import trunc_normal_, zeros_, ones_, to_2tuple, DropPath, Mlp
...
class SBlock(ViTBlock):
    def __init__(self,
        ...
        super().__init__(dim, num_heads, mlp_ratio, qkv_bias, qk_scale, drop,
                         attn_drop, drop_path, act_layer, layer_norm)
    ...
    def _init_weights(self, m):
        if isinstance(m, nn.Linear):
            try:
                ...
                if isinstance(m, nn.Linear) and m.biases is not None:
                    zeros_(m.biases)
...
class CPVTV2(PyramidVisionTransformer):
    ...
    def __init__(self,
        ...
        super().__init__(img_size, patch_size, in_chans, class_num, embed_dims,
                         ...
                         attn_drop_rate, drop_path_rate, layer_norm, depths,
                         sr_ratios, block_cls)
        del self.pos_embeds
        del self.cls_token
    ...
    def _init_weights(self, m):
        ...
        try:
            ...
            if isinstance(m, nn.Linear):
                ...
                fan_out //= m.n_group
                Normal(0, math.sqrt(2.0 / fan_out))(m.filters)

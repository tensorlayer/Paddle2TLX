...
# from ops.tlx_extend import tlx_MaxPool2d
...
class EntryFlowBottleneckBlock(nn.Layer):
    def __init__(self,
        ...
        self._pool = nn.MaxPool2D(kernel_size=3, stride=stride, padding=1)
...
def _xception(arch, entry_flow_block_num, middle_flow_block_num, pretrained, **kwargs):
...
def xception41(pretrained=False, **kwargs):
    return _xception("xception41", entry_flow_block_num=3, middle_flow_block_num=8, pretrained=pretrained, **kwargs)


def xception65(pretrained=False, **kwargs):
    return _xception("xception65", entry_flow_block_num=3, middle_flow_block_num=16, pretrained=pretrained, **kwargs)


def xception71(pretrained=False, **kwargs):
    return _xception("xception71", entry_flow_block_num=5, middle_flow_block_num=16, pretrained=pretrained, **kwargs)

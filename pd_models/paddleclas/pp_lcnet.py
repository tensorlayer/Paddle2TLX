...
from paddle.nn import AdaptiveAvgPool2D, BatchNorm2D, Conv2D, Linear#, Dropout
...
class PPLCNet(TheseusLayer):
    def __init__(self,
        ...
        # ])
        self.blocks2 = self.get_sequential_pd(self.net_config["blocks2"], scale)  # todo
        ...
        # ])
        self.blocks3 = self.get_sequential_pd(self.net_config["blocks3"], scale)
        ...
        # ])
        self.blocks4 = self.get_sequential_pd(self.net_config["blocks4"], scale)
        ...
        # ])
        self.blocks5 = self.get_sequential_pd(self.net_config["blocks5"], scale)
        ...
        # ])
        self.blocks6 = self.get_sequential_pd(self.net_config["blocks6"], scale)
...
#         # print(len(model.state_dict()), len(param))

...
# from ops.tlx_basic_pooling import tlx_AvgPool2d, tlx_MaxPool2d  # todo
...
class ConvBNLayer(nn.Layer):
    def __init__(self,
        ...
        # self.batch_norm = layers.SyncBatchNorm(
        #     out_channels, data_format=data_format)
        self.batch_norm = nn.BatchNorm2D(out_channels)  # todo

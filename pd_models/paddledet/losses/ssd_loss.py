...
from models.bbox_utils import iou_similarity, bbox2delta
...
class SSDLoss(nn.Layer):
    ...
    def _bipartite_match_for_batch(self, gt_bbox, gt_label, prior_boxes,
        ...
        batch_ind = paddle.arange(start=0, end=batch_size, dtype='int64').unsqueeze(-1)
        ...
        # Assign negative
        bg_index_tensor = paddle.full(shape=[batch_size, num_priors, 1], fill_value=bg_index,
                                      dtype='int64')

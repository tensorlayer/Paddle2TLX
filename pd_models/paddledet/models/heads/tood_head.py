...
from models.bbox_utils import bbox_center, batch_distance2bbox
...
class TaskDecomposition(nn.Layer):
    ...
    def forward(self, feat, avg_feat):
        ...
        aa = paddle.reshape(
            feat, [b, self.stacked_convs, self.feat_channels, h, w])
        feat = aa * weight
...
class TOODHead(nn.Layer):
    ...
    def get_loss(self, head_outs, gt_meta):
        ...
        num_pos = mask_positive.astype('float32')  # paddle.float32
        num_pos = num_pos.sum()

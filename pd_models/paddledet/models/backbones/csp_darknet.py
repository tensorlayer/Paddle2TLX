...
class CSPLayer(nn.Layer):
    ...
    def __init__(self,
        ...
        # ])
        self.bottlenecks = self.bottlenecks_layer_pd(hidden_channels,
                                                     hidden_channels,
                                                     shortcut,
                                                     depthwise,
                                                     bias,
    ...
    def bottlenecks_layer_pd(self, in_channels, out_channels, shortcut, depthwise, bias, act, num_blocks):
    ...
    def bottlenecks_layer_tlx(self, in_channels, out_channels, shortcut, depthwise, bias, act, num_blocks):
        if num_blocks == 1:
            bottlenecks = nn.Sequential([
                BottleNeck(
                    in_channels,

...
def predict_pd(model_pd, model_name="cyclegan"):
    ...
    if model_name == "cyclegan":
        ...
        # model.eval()
        results = model(inputs['A'].detach())  # has problem
    print('Predicted value:', results)
    return results
...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default="stylegan", help='train model name')
...
if __name__ == '__main__':
    ...
    predict_pd(model, model_name=args.model_name)

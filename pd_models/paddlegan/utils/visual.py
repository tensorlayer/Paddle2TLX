...
def tensor2img(input_image, min_max=(-1., 1.), image_num=1, imtype=np.uint8):
    ...
    if not isinstance(input_image, np.ndarray):
        ...
        if image_num == 1:
            ...
            # print(image_numpy[0][0][0])
            # print(f"before processing.image_numpy.shape={image_numpy.shape}")
            image_numpy = processing(image_numpy[0])
            # print(f"after processing.image_numpy.shape={image_numpy.shape}")
            # print(image_numpy[0][0][0])
        else:

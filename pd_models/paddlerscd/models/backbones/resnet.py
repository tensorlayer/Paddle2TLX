...
from paddle2tlx.pd2tlx.utils import load_model_cdet  # todo
...
class ResNet(nn.Layer):
    ...
    def __init__(self,
                 ...
                 with_pool=True,
                 strides=(1, 1, 2, 2, 2),
                 batch_norm=None):  # norm_layer -> batch_norm
        ...
        # self._batch_norm = nn.BatchNorm2D if batch_norm is None else batch_norm
        if batch_norm is None:  # todo
...
def _resnet(arch, Block, depth, pretrained, **kwargs):
    ...
    if pretrained:
        ...
        model = load_model_cdet(model, model_urls[arch][0], arch)
    return model

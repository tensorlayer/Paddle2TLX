...
DSIFN_URLS= 'https://paddlers.bj.bcebos.com/pretrained/cd/levircd/weights/dsifn_levircd.pdparams'
...
class DSIFN(nn.Layer):
    ...
    def __init__(self, num_classes, use_dropout=False):
        ...
        self.bn_ca1 = nn.BatchNorm2D(1024),  # todo
        ...
        self.trans_conv1 = nn.Conv2DTranspose(in_channels=512, out_channels=512, kernel_size=2, stride=2)
        ...
        self.trans_conv2 = nn.Conv2DTranspose(in_channels=256, out_channels=256, kernel_size=2, stride=2)
        ...
        self.trans_conv3 = nn.Conv2DTranspose(in_channels=128, out_channels=128, kernel_size=2, stride=2)
        ...
        self.trans_conv4 = nn.Conv2DTranspose(in_channels=64, out_channels=64, kernel_size=2, stride=2)
...
def _dsifn(pretrained=None, num_classes=2):
    ...
    if pretrained:
        model = load_model_cdet(model, DSIFN_URLS, "dsifn")
        # weight_path = download_and_decompress(DSIFN_URLS)

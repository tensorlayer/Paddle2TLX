...
FCEF_URLS = "https://paddlers.bj.bcebos.com/pretrained/cd/levircd/weights/fc_ef_levircd.pdparams"
...
def _fcef(pretrained=None, in_channels=6, num_classes=2):
    ...
    if pretrained:
        model = load_model_cdet(model, FCEF_URLS, "fcef")
        # weight_path = download_and_decompress(FCEF_URLS)

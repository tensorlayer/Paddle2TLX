...
# from ops.tlx_basic_sample import tlx_UpsamplingBilinear2d, tlx_Upsample
...
FCCDN_URLS = "https://paddlers.bj.bcebos.com/pretrained/cd/levircd/weights/fccdn_levircd.pdparams"
...
def _fccdn(pretrained=None, in_channels=3, num_classes=2):
    ...
    if pretrained:
        model = load_model_cdet(model, FCCDN_URLS, "fccdn")
        # weight_path = download_and_decompress(FCCDN_URLS)

...
class SqueezeExcitation(nn.Module):
    ...
    def __init__(self,
        ...
        self.avgpool = nn.AdaptiveAvgPool2d(output_size=1, data_format='channels_first')
        # self.fc1 = nn.Conv2D(input_channels, squeeze_channels, 1)
        self.fc1 = nn.Conv2d(in_channels=input_channels, out_channels=squeeze_channels, kernel_size=1, padding=0, data_format='channels_first')
        # self.fc2 = nn.Conv2D(squeeze_channels, input_channels, 1)
        self.fc2 = nn.Conv2d(in_channels=squeeze_channels, out_channels=input_channels, kernel_size=1, padding=0, data_format='channels_first')

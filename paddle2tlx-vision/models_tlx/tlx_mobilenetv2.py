...
class InvertedResidual(nn.Module):
    ...
    def __init__(self,
        ...
        layers.extend([
            ...
            nn.Conv2d(in_channels=hidden_dim, out_channels=oup, kernel_size=1, stride=1, padding=0, b_init=False, data_format='channels_first'),
            # norm_layer(oup),
            norm_layer(num_features=oup, data_format='channels_first'),
        ])
...
class MobileNetV2(nn.Module):
    ...
    def __init__(self, scale=1.0, num_classes=1000, with_pool=True):
        ...
        if with_pool:
            ...
            self.pool2d_avg = nn.AdaptiveAvgPool2d(output_size=1, data_format='channels_first')

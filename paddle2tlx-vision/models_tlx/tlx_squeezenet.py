...
from tensorlayerx.nn import Conv2d, Dropout
...
class MakeFire(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return tlx.ops.concat([x1, x2], axis=1)
...
class SqueezeNet(nn.Module):
    ...
    def __init__(self, version, num_classes=1000, with_pool=True):
        ...
        if self.version == "1.0":
            ...
            #                     weight_attr=ParamAttr(),
            #                     bias_attr=ParamAttr())
            self._conv = Conv2d(in_channels=3,
                                out_channels=96,
                                kernel_size=7,
                                stride=2,
                                padding=0,  # TODO
        ...
        self._drop = Dropout(p=0.5, name="downscale_in_infer")
        # self._conv9 = Conv2D(512,
        #                      num_classes,
        #                      1,
        #                      weight_attr=ParamAttr(),
        #                      bias_attr=ParamAttr())
        self._conv9 = Conv2d(in_channels=512,
        ...
        self._avg_pool = AdaptiveAvgPool2d(output_size=1, data_format='channels_first')

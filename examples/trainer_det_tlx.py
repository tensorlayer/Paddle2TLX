...
# 已转：Mask_RCNN, Faster_RCNN, CascadeRCNN, TTFNet, SOLOv2, YOLOv3, YOLOX, SSD, CenterNet, picodet_lcnet, TOOD, GFL, fcos_r50, fcos_dcn, RetinaNet
tlx_project_path = '/home/sthq/scc/paddle2tlx/my_project/paddleclas/paddledetection'
...
def load_tlx_model(tlx_project_path, model_name="YOLOV3"):
    ...
    from det.engine.trainer_tlx import Trainer

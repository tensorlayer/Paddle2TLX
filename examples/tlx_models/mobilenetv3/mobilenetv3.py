    ...
    def __init__(self, in_channels, expanded_channels, out_channels,
        ...
        if self.expand:
            self.expand_conv = ConvNormActivation(in_channels=in_channels,
                ...
                padding=0, norm_layer=norm_layer, activation_layer=\
                activation_layer)
...
class MobileNetV3(nn.Module):
    ...
    def __init__(self, config, last_channel, scale=1.0, num_classes=1000,
        ...
        self.conv = ConvNormActivation(in_channels=3, out_channels=self.
            ...
            groups=1, activation_layer=nn.Hardswish, norm_layer=norm_layer)
        self.blocks = nn.Sequential(*[InvertedResidual(in_channels=cfg.
            ...
            activation_layer, norm_layer=norm_layer) for cfg in self.config])
        ...
        if num_classes > 0:
            self.classifier = nn.Sequential(nn.Linear(in_features=self.
                ...
                Hardswish(), nn.Dropout(p=0.2), nn.Linear(in_features=self.
                last_channel, out_features=num_classes))

...
class TTFNet(BaseArch):
    ...
    def __init__(self, backbone='DarkNet', neck='TTFFPN', ttf_head=\
        'TTFHead', post_process='BBoxPostProcess'):
    ...
    def from_config(cls, cfg, *args, **kwargs):
        ...
        return {'backbone': backbone, 'neck': neck, 'ttf_head': ttf_head}
    ...
    def _forward(self):
        ...
        if self.training:
            ...
            bbox, bbox_num = self.post_process(hm, wh, self.inputs[

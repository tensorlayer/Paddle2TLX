...
class SOLOv2(BaseArch):
    ...
    def from_config(cls, cfg, *args, **kwargs):
        ...
        return {'backbone': backbone, 'neck': neck, 'solov2_head':
            solov2_head, 'mask_head': mask_head}

    def model_arch(self):
        print(f'model_arch self.inputs={self.inputs}')
    ...
    def get_loss(self):
        ...
        loss_solov2 = self.solov2_head.get_loss(self.cate_pred_list, self.
            kernel_pred_list, self.seg_pred, gt_ins_labels, gt_cate_labels,
            gt_grid_orders, fg_num)
    ...
    def get_pred(self):
        seg_masks, cate_labels, cate_scores, bbox_num = (self.solov2_head.
            get_prediction(self.cate_pred_list, self.kernel_pred_list, self
            .seg_pred, self.inputs['im_shape'], self.inputs['scale_factor']))
        outs = {'segm': seg_masks, 'bbox_num': bbox_num, 'cate_label':
            cate_labels, 'cate_score': cate_scores}
        return outs

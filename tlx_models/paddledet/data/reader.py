...
class BaseDataLoader(object):
    ...
    def __call__(self, dataset, worker_num, batch_sampler=None, return_list
        ...
        self.dataloader = DataLoader(dataset=self.dataset, batch_size=self.
            batch_size, shuffle=self.shuffle, drop_last=self.drop_last,
            use_shared_memory=use_shared_memory, num_workers=worker_num,
